...
def get_indexer():
    ...
    INDEXER_NAME="es1indexer"#os.getenv("INDEXER_NAME")
    ...
    indexer = SearchIndexer(  
        ...
        # field_mappings=[FieldMapping(source_field_name=field, target_field_name=field) for field in ["header","content","page", "vector"]],
